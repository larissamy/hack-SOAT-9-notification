...
public class ErrorNotificationListenerTest {
    ...
    public void setUp() {
        ...
        listener = new ErrorNotificationListener(mailSender, "fiap@fiap.com", "Erro");
    }
    ...
    public void shouldSendEmailWhenErrorMessageReceived() {
        ...
        assertEquals("fiap@fiap.com", email.getFrom());
        assertEquals("Erro", email.getSubject());
        assertEquals(true, email.getText().contains("Erro no processamento"));
    }
}
